...
//        public IActionResult Index(NotificationResponse notification)
//        {
...
//       int ActionType)
//        {
//            var session = HttpContext.Session.GetObject<MVC_Project.Models.Auth.UserSession>(
//                MVC_Project.Constants.SessionKeys.UserSession);
//            if (session == null) return RedirectToAction("Login", "Auth");
...
//        [HttpPost]
//        public async Task<IActionResult> AddOrUpdateNotification(
//            int NotificationID,
//            string Title,
//            string Description,
//            string Filepath,
...
//            //    return View("Index", new NotificationResponse { Description = model.Description });
...
//                switch (notification)
//                {
//                    case "5_0": model.Type = 1; break;  // About Us
//                    case "4_0": model.Type = 2; break;  // Principal Message
//                    case "7_0": model.Type = 3; break;  // Mission
//                    case "8_0": model.Type = 4; break;// Vision                 
//                    default: model.Type = 4; break;
//                }
...
//                if (updateResponse?.IsSuccess == true)
//                {
//                    TempData["SuccessMessage"] = updateResponse.Message ?? "Notification updated successfully!";
//                    var result = await _notificationService.GetNotificationDataAsync(notification);
//                    var response = new NotificationResponse();
//                    if (result?.IsSuccess == true && result.ResponseData != null)
//                    {
//                        var item = result.ResponseData.FirstOrDefault();
...
//                TempData["ErrorMessage"] = updateResponse?.Message ?? "Update failed. Please try again.";
//            }
//            catch (Exception ex)
//            {
//                _logger.LogError(ex, "Error updating notification");
...
//            var currentResult = await _notificationService.GetNotificationDataAsync(notification);
//            var currentResponse = new NotificationResponse();
//            if (currentResult?.IsSuccess == true && currentResult.ResponseData != null)
//            {
//                var item = currentResult.ResponseData.FirstOrDefault();
//                if (item != null)
//                    currentResponse = new NotificationResponse
//                    {
//                        Description = item.Description,
//                        FilePath = item.FilePath
//                    };
...
//            return RedirectToAction("Index", currentResponse);
//        }
//    }
//}